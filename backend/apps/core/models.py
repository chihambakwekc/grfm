...
class Province(models.Model):
    ...
    toll_free_number = models.CharField(max_length=40, blank=True)
...
class PublicSubmission(models.Model):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, related_name="public_submissions", null=True, blank=True)
